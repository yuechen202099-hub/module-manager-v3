    ...
    modules: [
      {
        ...
        name: '项目进度',
        priority: 10,
        endpoint: '/projects/local-test/modules/progress',
      ...
      },
      {
        ...
        name: '项目交付能力',
        priority: 20,
        endpoint: '/projects/local-test/modules/delivery',
        routePath: '/project-board',
      },
      {
        id: 'field',
        name: '现场采集',
        priority: 30,
        endpoint: '/projects/local-test/modules/field',
      ...
      },
      {
        ...
        name: '审阅功能',
        priority: 40,
        endpoint: '/projects/local-test/modules/review',
        routePath: '/task-hall',
      },
    ],
  },
