...
- Name: `module-manager-v2-server-3.2.9.zip`
- Version: 3.2.9
...
- V3.2.0 historical boundaries, V3.2.1/V3.2.2 KPI history, the immutable V3.2.3 through V3.2.8 records, and the V3.2.9 inventory scanner hotfix evidence
...
.\.venv\Scripts\python.exe .\scripts\verify_release_sop.py --version V3.2.9 --phase source
...
- Historical release contracts plus the active V3.2.9 Quagga-first inventory scanner and camera lifecycle regressions must pass
