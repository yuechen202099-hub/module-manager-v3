...
- Package: `build/server-release/module-manager-v2-server-3.2.10.zip`
- Name: `module-manager-v2-server-3.2.10.zip`
- Version: 3.2.10
...
- V3.2.0 historical boundaries, immutable V3.2.3 through V3.2.9 records, V3.2.9 Quagga-first scanner regressions, and V3.2.10 unified terminal review/re-photo gates
...
- Historical release contracts plus the active V3.2.10 terminal review, PostgreSQL concurrency, Quagga-first scanner, package and lifecycle contracts must pass
