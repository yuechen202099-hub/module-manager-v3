...
- Package: `build/server-release/module-manager-v2-server-3.2.15.zip`
- Name: `module-manager-v2-server-3.2.15.zip`
- Version: 3.2.15
...
- V3.2.0 historical boundaries, immutable V3.2.3 through V3.2.14 records, V3.2.9 Quagga-first scanner regressions, V3.2.13 classification-independent rephoto gates, V3.2.14 archive/manual-demand/source-photo gates, and V3.2.15 exception-count/deferred-image gates
...
.\.venv\Scripts\python.exe .\scripts\verify_release_sop.py --version V3.2.15 --phase source
...
- Historical release contracts plus the active V3.2.15 exception-count, deferred-image, package, and lifecycle contracts must pass
