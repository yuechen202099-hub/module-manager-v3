...
- Package: `build/server-release/module-manager-v2-server-3.2.24.zip`
- Name: `module-manager-v2-server-3.2.24.zip`
- Version: 3.2.24
...
- V3.2.0 historical boundaries, immutable V3.2.3 through V3.2.23 records, V3.2.9 Quagga-first scanner regressions, V3.2.13 classification-independent rephoto gates, V3.2.14 archive/manual-demand/source-photo gates, V3.2.15 exception-count/deferred-image gates, V3.2.16 reviewer-claim removal gates, V3.2.17 anomaly-confirmation/meter-module-export gates, V3.2.18 approved-exception closure gates, V3.2.19 terminal meter-number deduplication gates, V3.2.20 effective collector/module display gates, V3.2.21 audited bulk anomaly approval gates, V3.2.22 complete meter-module candidate export gates, V3.2.23 data-center save/photo workflow gates, and V3.2.24 effective identity synchronization gates
...
.\.venv\Scripts\python.exe .\scripts\verify_release_sop.py --version V3.2.24 --phase source
...
- Historical release contracts plus the active V3.2.24 effective identity synchronization, package, and lifecycle contracts must pass
