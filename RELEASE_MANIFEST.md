...
- Package: `build/server-release/module-manager-v2-server-3.2.12.zip`
- Name: `module-manager-v2-server-3.2.12.zip`
- Version: 3.2.12
...
- V3.2.0 historical boundaries, immutable V3.2.3 through V3.2.11 records, V3.2.9 Quagga-first scanner regressions, and the V3.2.12 manual-classification confirmation gates
...
.\.venv\Scripts\python.exe .\scripts\verify_release_sop.py --version V3.2.12 --phase source
...
- Historical release contracts plus the active V3.2.12 confirmation, revocation, package, and lifecycle contracts must pass
