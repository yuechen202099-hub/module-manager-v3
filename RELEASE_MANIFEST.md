...
- Package: `build/server-release/module-manager-v2-server-3.2.11.zip`
- Name: `module-manager-v2-server-3.2.11.zip`
- Version: 3.2.11
...
- V3.2.0 historical boundaries, immutable V3.2.3 through V3.2.10 records, V3.2.9 Quagga-first scanner regressions, and V3.2.11 review/re-photo and scanner-dialog hotfix gates
...
- Historical release contracts plus the active V3.2.11 terminal review, scanner dialog, package and lifecycle contracts must pass
