...
- Current production baseline: `V3.0.74`.
- Production maintenance branch: `production/V3/3.0.74`.
...
- 当前应用基线：`V3.0.74`。
- 当前生产分支：`production/V3/3.0.74`。
- 生产分支命名规则：`production/V3/<version>`，例如 `production/V3/3.0.74`。旧 `production/v3.0.35` 仅保留历史兼容，不作为新开发基线。
