...
- 生产维护分支：`production/V3/3.0.83`
- 当前生产应用基线：`V3.0.82`
- 当前发布候选版本：`V3.0.83`
- 当前生产 release：`/opt/module-manager-v2/releases/v3.0.82-20260719_132400`
- 当前回滚 release：`/opt/module-manager-v2/releases/v3.0.81-20260719_110850`
- 生产分支命名规则：`production/V3/<version>`，例如 `production/V3/3.0.83`。旧 `production/v3.0.35` 仅保留历史兼容，不作为新开发基线。
