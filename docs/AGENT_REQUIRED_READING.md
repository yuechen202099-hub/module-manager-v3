...
- 生产维护分支：`production/V3/3.2.28`
- 当前生产应用基线：`V3.2.27`
- 当前发布候选版本：`V3.2.28`
- 当前生产 release：`/opt/module-manager-v2/releases/v3.2.27-20260901T182548Z`
- 当前回滚 release：`/opt/module-manager-v2/releases/v3.2.26-20260901T012936Z`
- 当前生产提交：`5b387db2431293c756ffca61803678160dae5ad5`
