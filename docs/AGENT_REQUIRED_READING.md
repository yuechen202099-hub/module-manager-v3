...
- 生产维护分支：`production/V3/3.2.29`
- 当前生产应用基线：`V3.2.28`
- 当前发布候选版本：`V3.2.29`
- 当前生产 release：`/opt/module-manager-v2/releases/v3.2.28-20260903T025907Z`
- 当前回滚 release：`/opt/module-manager-v2/releases/v3.2.27-20260901T182548Z`
- 当前生产提交：`a095c7fd0fd90f1e9cb79705f937bbd689b81002`
