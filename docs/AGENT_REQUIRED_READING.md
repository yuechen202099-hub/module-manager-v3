...
- 生产维护分支：`production/V3/3.0.84`
- 当前生产应用基线：`V3.0.84`
- 当前发布候选版本：`V3.0.84`
- 当前生产 release：`/opt/module-manager-v2/releases/v3.0.84-20260722_033636`
- 当前回滚 release：`/opt/module-manager-v2/releases/v3.0.83-20260721_214617`
- 生产分支命名规则：`production/V3/<version>`，例如 `production/V3/3.0.84`。旧 `production/v3.0.35` 仅保留历史兼容，不作为新开发基线。
