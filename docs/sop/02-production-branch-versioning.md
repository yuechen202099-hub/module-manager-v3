...
- Production maintenance branch: `production/V3/3.0.80`
- Current production app version: `V3.0.80`
...
- Production branch names use `production/V3/<version>`, for example `production/V3/3.0.80`.
...
| Every bug fix | Exactly `+0.0.1` |
| Small feature | `+0.0.1` unless the user approves a larger change |
