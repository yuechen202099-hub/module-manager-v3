...
- Project management platform work may use an independent progress version such as `PM-V1.0.xx` for platform-team planning, while still recording the production baseline it is based on, for example `based on production V3.0.77`.
