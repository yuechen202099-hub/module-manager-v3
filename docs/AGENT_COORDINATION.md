...
| V2.5.8 | Project engineer thread | Installer KPI work start/end time, estimated duration, and hourly duration chart | Ready for deployment | Local implementation and gates complete. Effective work duration excludes adjacent scan/upload gaps over 60 minutes; no Alembic migration required. |
