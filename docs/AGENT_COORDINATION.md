...
| V2.5.5 | BUG fix thread | Backfill historical construction-upload installer names | Fixed locally | Added a dry-run/apply script to rewrite historical construction photo creator values from account username to user display name in PostgreSQL and optional JSON state; pending project-engineer production dry-run/apply. |
