...
| V2.6.2 | Project engineer thread | Refine installer KPI time chart to Apple Screen Time style | Ready for patch deployment | Scope: removed completion line chart, kept 2-hour bars and address drilldown, improved KPI dialog spacing/visual hierarchy, bumped version metadata, rebuilt Vue bundle, docs/tests. No backend API or database change. |
