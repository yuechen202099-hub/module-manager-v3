...
| V2.5.2 | BUG fix thread | Construction mobile permanent task cards click-through hotfix | Fixed locally | Field-task cards now resolve by task id or terminal and listed cards are fully clickable; pending project-engineer publish. |
