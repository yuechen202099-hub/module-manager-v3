...
| V2.6.1 | BUG fix thread | Installer KPI popup PostgreSQL field hotfix | Ready for deployment | Local gates passed. Scope limited to `state_repository.py`, `test_state_repository.py`, version metadata, generated Vue bundle, and maintenance docs. No Alembic migration required. |
